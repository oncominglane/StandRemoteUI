...
#Region "Parameter values definition"
        ...
        ''' </summary>
        Public Const LAN_DIRECTION_READ As Integer = &H1
        ''' <summary>
        ''' The PCAN-Channel Is limited to outgoing communication only
        ''' </summary>
        Public Const LAN_DIRECTION_WRITE As Integer = &H2
        ''' <summary>
        ''' The PCAN-Channel communication Is bidirectional 
        ''' </summary>
        Public Const LAN_DIRECTION_READ_WRITE As Integer = LAN_DIRECTION_READ Or LAN_DIRECTION_WRITE
#End Region
...
#Region "Lookup Parameters"
        ...
        ''' </summary>
        Public Const LOOKUP_DEVICE_GUID As String = "deviceguid"
#End Region
